...
# import random
# import subprocess
# from docker_tw import *
# from tests.base_project import BaseProject
# import os
# from pathlib import Path

# TW_SVG_FOLDER = os.environ.get('TW_SVG_FOLDER')

# class Projeto1A(BaseProject):
#     def __init__(self, git_username, repository, release) -> None:
#         super().__init__(git_username, repository, release, "Projeto1A")
...
#         self.container = DockerProject1ARunner()
...
#         self.driver.save_screenshot(f'{TW_SVG_FOLDER}/ss_{self.git_username}_{self.repository}.png')
